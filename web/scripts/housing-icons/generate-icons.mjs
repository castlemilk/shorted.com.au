// Housing iconography — the robust generation flow.
//
...
//
// Usage:
//   MODE=live node web/scripts/housing-icons/generate-icons.mjs            # all icons
...
const client = new Client({ name: "housing-icons", version: "1.0.0" });
...
async function runBatch(batch, idx) {
  const created = sc(await call("create_asset_flow", {
    title: `Shorted Housing Icons — batch ${idx + 1}`,
    goal: "cohesive warm-duotone icon set for the housing data view",

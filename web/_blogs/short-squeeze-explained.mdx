...
3. **Covering begins**: As the price rises, short sellers face mounting losses. Their brokers may issue margin calls, forcing them to buy shares at market price.
...
Stocks with very high short interest as a percentage of total shares on issue are the most likely candidates for a squeeze. On the ASX, you can track this daily through ASIC's short position reports — or more easily through [Shorted.com.au](https://shorted.com.au).
...
By tracking this data consistently — which is exactly what [Shorted](https://shorted.com.au) is built to do — you can build an understanding of which stocks are under pressure, which sectors are seeing increased bearish sentiment, and where the conditions for a squeeze might be forming.
...
[Monitor ASX short squeeze candidates →](https://shorted.com.au)

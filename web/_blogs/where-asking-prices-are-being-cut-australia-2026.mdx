...
<GraphStat title="30 days to 24 September 2026, 500-suburb panel" items={[
  { value: "10.5%", label: "of listings cut their price", accent: true },
  { value: "4.3%", label: "median cut", hint: "average 5.3%" },
  { value: "$110M", label: "asking price removed" },
]} />
...
<GraphRank title="Share of listings discounted, past 30 days" max={35} items={[
  { label: "Fawkner", value: 29.7, display: "29.7%" },
  { label: "Frankston South", value: 27.0, display: "27.0%" },
  { label: "Manor Lakes", value: 25.4, display: "25.4%" },
  { label: "Altona North", value: 24.0, display: "24.0%" },
  { label: "Seaford", value: 23.0, display: "23.0%" },
  { label: "Narre Warren South", value: 23.0, display: "23.0%" },
  { label: "Burpengary", value: 22.7, display: "22.7%" },
  { label: "Altona Meadows", value: 20.5, display: "20.5%" },
]} />

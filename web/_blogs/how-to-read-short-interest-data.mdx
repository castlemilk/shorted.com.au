...
[Short interest](/glossary/short-interest) represents the total number of shares that have been sold short but not yet covered. On the ASX, this data is reported daily to ASIC and made publicly available, providing transparency into market sentiment.
...
- **Implications**: Either serious fundamental issues or potential [short squeeze](/learn/short-squeeze-mechanics) candidate
- **Investor Action**: Detailed fundamental analysis required

## Analyzing Trends and Patterns

Raw percentages only tell part of the story. [Trend analysis](/learn/reading-short-interest-changes) provides deeper insights:
...
### [Days to Cover](/glossary/days-to-cover) Calculation

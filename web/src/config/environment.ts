...
export const config = {
  ...
  api: {
    ...
    marketData: process.env.NEXT_PUBLIC_MARKET_DATA_URL || 'http://localhost:8090',
  },
  ...
  cache: {
    ...
    ttl: environment === 'production' ? 3600 : environment === 'preview' ? 300 : 0,
  },
...
export function isPreviewDeployment(): boolean {
  ...
  if (typeof window !== 'undefined') {
    return window.location.hostname.includes('pr-') || 

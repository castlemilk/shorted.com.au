...
const PALETTES: StockChipPalette[] = [
  {
    ...
    onCard: "bg-orange-500/10 text-orange-300 border border-orange-500/30",
  },
  {
    onImage: "border-sky-500/40 bg-zinc-950/80 text-sky-300",
    onCard: "bg-sky-500/10 text-sky-300 border border-sky-500/30",
  },
  {
    onImage: "border-emerald-500/40 bg-zinc-950/80 text-emerald-300",
    onCard: "bg-emerald-500/10 text-emerald-300 border border-emerald-500/30",
  },
  {
    onImage: "border-violet-500/40 bg-zinc-950/80 text-violet-300",
    onCard: "bg-violet-500/10 text-violet-300 border border-violet-500/30",
  },
  {
    onImage: "border-rose-500/40 bg-zinc-950/80 text-rose-300",
    onCard: "bg-rose-500/10 text-rose-300 border border-rose-500/30",
  },
  {
    onImage: "border-amber-500/40 bg-zinc-950/80 text-amber-300",
    onCard: "bg-amber-500/10 text-amber-300 border border-amber-500/30",
  },
  {
    onImage: "border-cyan-500/40 bg-zinc-950/80 text-cyan-300",
    onCard: "bg-cyan-500/10 text-cyan-300 border border-cyan-500/30",
  },
  {
    onImage: "border-fuchsia-500/40 bg-zinc-950/80 text-fuchsia-300",
    onCard: "bg-fuchsia-500/10 text-fuchsia-300 border border-fuchsia-500/30",
  },
];

"use client"
// Vendored from mdxcn (https://mdxcn.dev, MIT) via its shadcn registry — see ../README.md
// before editing. Tailwind v4 utilities/tokens are ported in src/styles/globals.css.

// Terms of Service under proprietary license in Australia
...
const Page = () => {
  return (
    <div>
      ...
      <p>
        Welcome to Shorted Pty Ltd ("Company", "we", "our", "us"). These Terms
      ...
      <p>
        ...
        the exclusive property of the Company and are protected by Australian
      ...
      <p>
        ...
        Company makes no warranties, expressed or implied, and hereby disclaims
      ...
      <p>
        ...
        the materials on the Website, even if the Company or an authorized
      ...
      <p>
        ...
        typographical, or photographic errors. The Company does not warrant that
        any of the materials on its Website are accurate, complete, or current.
        The Company may make changes to the materials contained on its Website
        at any time without notice.
      </p>

      <h2>8. Links</h2>
      <p>
        The Company has not reviewed all of the sites linked to its Website and
        is not responsible for the contents of any such linked site. The
        inclusion of any link does not imply endorsement by the Company. Use of
      ...
      <p>
        ...
        respect to the Website or the information contained on the Website for
        any purpose. Any reliance you place on such information is therefore
        strictly at your own risk. You should consider seeking independent
        legal, financial, taxation, or other advice to check how the Website
        information relates to your unique circumstances.
      </p>
    </div>
  );
};

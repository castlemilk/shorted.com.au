...
export function SignInClient({ callbackUrl }: SignInClientProps) {
  ...
  // Debug logging
  useEffect(() => {
    console.log("[SignIn Debug]", { status, hasSession: !!session, callbackUrl });
  }, [status, session, callbackUrl]);

  // Redirect authenticated users
  useEffect(() => {
    if (status === "authenticated" && session) {
      console.log("[SignIn] Client-side redirecting to:", callbackUrl);
  ...
  // If we have a session but status isn't "authenticated" yet, show loading

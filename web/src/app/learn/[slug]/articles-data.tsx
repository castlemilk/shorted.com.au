 ...
 *
 * Lives here, NOT in page.tsx: Next restricts which fields a page file may
 * export, and `export const articlesData` there fails the production build
 * with "articlesData is not a valid Page export field" — a build-time rule
 * that `tsc --noEmit` does not catch. The route's opengraph-image.tsx needs
 * this data to title the share card, so it has to be importable.
 */

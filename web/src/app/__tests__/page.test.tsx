...
jest.mock('@next/third-parties/google', () => ({
  GoogleAnalytics: ({ gaId }: any) => <div data-testid="google-analytics" data-ga-id={gaId}></div>,
}));
...
const mockGetIndustryTreeMap = getIndustryTreeMap as jest.MockedFunction<typeof getIndustryTreeMap>;

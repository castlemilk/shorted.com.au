// Auto-generated from critical.css
// This allows importing the CSS as a string for inlining in <head>
export const criticalCSS = `
/* Critical CSS - Above the fold styles only
 * This CSS is inlined in the <head> to prevent render-blocking
 * Keep this file minimal - only essential styles for initial render
 */

...
const interpolatePuOr = (t) => `rgb-puor-${t}`;
const interpolateBlues = (t) => `rgb-blues-${t}`;

module.exports = { interpolateBlues, interpolateOranges, interpolateRdBu, interpolateYlOrRd, interpolatePuOr };

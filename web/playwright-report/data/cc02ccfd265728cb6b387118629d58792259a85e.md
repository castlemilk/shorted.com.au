...
- Name: Algolia Search Functionality >> should search by stock code exactly
- Location: /Users/benebsworth/projects/shorted/web/e2e/algolia-search.spec.ts:122:3
...
Call log:
  - waiting for locator('input[placeholder*="Search"], input[type="search"]').first()
    ...
    at /Users/benebsworth/projects/shorted/web/e2e/algolia-search.spec.ts:128:23
```

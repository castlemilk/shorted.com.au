...
- Name: Algolia Search Functionality >> should find stocks with typo tolerance
- Location: /Users/benebsworth/projects/shorted/web/e2e/algolia-search.spec.ts:33:3
...
Call log:
  - waiting for locator('input[placeholder*="Search"], input[type="search"]').first()
    ...
    at /Users/benebsworth/projects/shorted/web/e2e/algolia-search.spec.ts:39:23
```

...
- Name: Algolia Search Functionality >> should handle empty search gracefully
- Location: /Users/benebsworth/projects/shorted/web/e2e/algolia-search.spec.ts:107:3
...
Call log:
  - waiting for locator('input[placeholder*="Search"], input[type="search"]').first()
    ...
    at /Users/benebsworth/projects/shorted/web/e2e/algolia-search.spec.ts:113:23
```

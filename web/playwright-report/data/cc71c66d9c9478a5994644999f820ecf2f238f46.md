...
- Name: Algolia Search Functionality >> should search across company descriptions (elastic search)
- Location: /Users/benebsworth/projects/shorted/web/e2e/algolia-search.spec.ts:54:3
...
Call log:
  - waiting for locator('input[placeholder*="Search"], input[type="search"]').first()
    ...
    at /Users/benebsworth/projects/shorted/web/e2e/algolia-search.spec.ts:62:23
```

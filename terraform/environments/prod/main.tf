...
# =============================================================================
# Provider v5 migration imports (June 2026) — one-time bring-up of the
# cloudflare_zone_setting resources that replaced the removed-in-v5
# cloudflare_zone_settings_override, plus the split-out argo tiered caching.
# Safe to delete after the first successful apply on v5.
# =============================================================================

import {
  to = module.edge.cloudflare_zone_setting.security_always_use_https
  id = "${var.cloudflare_zone_id}/always_use_https"
}

import {
  to = module.edge.cloudflare_zone_setting.security_automatic_https_rewrites
  id = "${var.cloudflare_zone_id}/automatic_https_rewrites"
}

import {
  to = module.edge.cloudflare_zone_setting.security_early_hints
  id = "${var.cloudflare_zone_id}/early_hints"
}

import {
  to = module.edge.cloudflare_zone_setting.security_http3
  id = "${var.cloudflare_zone_id}/http3"
}

import {
  to = module.edge.cloudflare_zone_setting.security_min_tls_version
  id = "${var.cloudflare_zone_id}/min_tls_version"
}

import {
  to = module.edge.cloudflare_zone_setting.security_polish
  id = "${var.cloudflare_zone_id}/polish"
}

import {
  to = module.edge.cloudflare_zone_setting.security_speed_brain
  id = "${var.cloudflare_zone_id}/speed_brain"
}

import {
  to = module.edge.cloudflare_zone_setting.security_ssl
  id = "${var.cloudflare_zone_id}/ssl"
}

import {
  to = module.edge.cloudflare_zone_setting.security_webp
  id = "${var.cloudflare_zone_id}/webp"
}

import {
  to = module.edge.cloudflare_zone_setting.security_zero_rtt
  id = "${var.cloudflare_zone_id}/0rtt"
}

import {
  to = module.edge.cloudflare_zone_setting.markdown_for_agents
  id = "${var.cloudflare_zone_id}/content_converter"
}

import {
  to = module.edge.cloudflare_argo_tiered_caching.smart

...
async def create_stock_prices_table(conn):
    ...
    # Create indexes
    await conn.execute("CREATE INDEX IF NOT EXISTS idx_stock_prices_stock_code ON stock_prices(stock_code)")
    await conn.execute("CREATE INDEX IF NOT EXISTS idx_stock_prices_date ON stock_prices(date DESC)")
    await conn.execute("CREATE INDEX IF NOT EXISTS idx_stock_prices_stock_date ON stock_prices(stock_code, date DESC)")

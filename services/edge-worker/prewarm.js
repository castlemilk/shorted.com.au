...
const PREWARM_ENDPOINTS = [
  ...
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "CBA" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "BHP" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "PLS" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "LYC" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "MIN" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "NCM" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "ANZ" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "WBC" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "RIO" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "CSL" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "FMG" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "WOW" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "TLS" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "NAB" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "MQG" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "WES" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "SUN" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "ALQ" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetStockPrice", body: { stock_code: "BXB" }, origin: "market" },
  // Historical prices (top 10)
  { path: "/market_data.v1.MarketDataService/GetHistoricalPrices", body: { stock_code: "CBA", period: "3m" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetHistoricalPrices", body: { stock_code: "BHP", period: "3m" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetHistoricalPrices", body: { stock_code: "PLS", period: "3m" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetHistoricalPrices", body: { stock_code: "LYC", period: "3m" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetHistoricalPrices", body: { stock_code: "MIN", period: "3m" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetHistoricalPrices", body: { stock_code: "NCM", period: "3m" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetHistoricalPrices", body: { stock_code: "ANZ", period: "3m" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetHistoricalPrices", body: { stock_code: "WBC", period: "3m" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetHistoricalPrices", body: { stock_code: "RIO", period: "3m" }, origin: "market" },
  { path: "/market_data.v1.MarketDataService/GetHistoricalPrices", body: { stock_code: "CSL", period: "3m" }, origin: "market" },
  // Bulk price fetch (already covers top 20)
  { path: "/market_data.v1.MarketDataService/GetMultipleStockPrices", body: { stock_codes: ["CBA", "BHP", "PLS", "LYC", "MIN", "NCM", "ANZ", "WBC", "RIO", "CSL", "FMG", "FMG", "WOW", "TLS", "NAB", "MQG", "WES", "SUN", "ALQ", "BXB"] }, origin: "market" },
];

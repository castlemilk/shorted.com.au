...
func cleanCompanyName(name string) string {
	...
	// Title case
	//nolint:staticcheck // strings.Title is deprecated, but x/text/cases title-cases
	// differently around punctuation; these company names are compared downstream,
	// so the exact output is preserved rather than silently changed by this port.

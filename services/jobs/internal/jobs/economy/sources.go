...
var sourceDefs = []sourceDef{
	...
	{"worldbank-pink-sheet", "World Bank Commodity Markets (Pink Sheet)", "economic_series",
		...
		"Monthly spot prices — bulk (iron ore, Australian and South African coal), gas (LNG Japan, Europe, US), base metals (copper, aluminium, nickel, zinc, lead, tin), precious (gold, silver, platinum), fertiliser (urea, DAP, phosphate rock, potash) and agriculture (wheat, cotton, sugar, beef). Workbook URL discovered per run — the path is issue-year versioned and a stale one serves old data rather than 404ing."},
	{"fred-us-macro", "FRED US macro (rates, prices, dollar, crude, FX)", "economic_series",
		"Federal Reserve Bank of St. Louis (FRED)", "https://fred.stlouisfed.org/",
		"public-domain-us-gov", "Monthly", "api",
		"US Treasury curve (3m/2y/10y/30y), fed funds, 10y-2y spread, 10y breakeven, CPI, unemployment, industrial production, M2, Fed balance sheet, the broad dollar index, WTI and Brent crude, and nine FX pairs. Daily and weekly series stored month-end; monthly ones as published. The licence column is the importer's DEFAULT — VIXCLS (CBOE) and BAMLH0A0HYM2 (ICE) carry their own proprietary licence and are internal_only."},

...
type Store interface {
	...
	GetSuburbIndex(stateCode string) (*SuburbIndexResult, error)
	GetSuburbMetricColumns(stateCode string, metricKeys []string) (*SuburbMetricColumnsResult, error)
	FilterSuburbs(stateCode string, predicates []SuburbMetricPredicateRow) (*SuburbFilterResult, error)

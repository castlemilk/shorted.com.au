...
func file_stocks_v1alpha1_stocks_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_stocks_v1alpha1_stocks_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_stocks_v1alpha1_stocks_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {

...
var file_stocks_v1alpha1_stocks_proto_rawDesc = []byte{
	...
	,
	...
	0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0d, 0x73, 0x68, 0x6f, 0x72, 0x74, 0x50,
	0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0xda, 0x01, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e,
...
func file_stocks_v1alpha1_stocks_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_stocks_v1alpha1_stocks_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Stock); i {
			case 0:
				return &v.state
			case 1:
		...
		file_stocks_v1alpha1_stocks_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_stocks_v1alpha1_stocks_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_stocks_v1alpha1_stocks_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_stocks_v1alpha1_stocks_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*IndustryTreeMap); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_stocks_v1alpha1_stocks_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*TreemapShortPosition); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

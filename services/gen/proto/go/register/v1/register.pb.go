...
const file_register_v1_register_proto_rawDesc = "" +
	"\n" +
	"\x1aregister/v1/register.proto\x12\vregister.v1\x1a\x1cgoogle/api/annotations.proto\x1a$gnostic/openapi/v3/annotations.proto\x1a\x18options/v1/options.proto\",\n" +

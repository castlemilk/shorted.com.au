...
const (
	...
	// ShortedStocksServiceGetStockPricesProcedure is the fully-qualified name of the
	// ShortedStocksService's GetStockPrices RPC.
	ShortedStocksServiceGetStockPricesProcedure = "/shorts.v1alpha1.ShortedStocksService/GetStockPrices"
	...
	// ShortedStocksServiceGetIndexSeriesProcedure is the fully-qualified name of the
	// ShortedStocksService's GetIndexSeries RPC.
	ShortedStocksServiceGetIndexSeriesProcedure = "/shorts.v1alpha1.ShortedStocksService/GetIndexSeries"
	// ShortedStocksServiceListIndicesProcedure is the fully-qualified name of the
	// ShortedStocksService's ListIndices RPC.
	ShortedStocksServiceListIndicesProcedure = "/shorts.v1alpha1.ShortedStocksService/ListIndices"
	...
	// ShortedStocksServiceGetSuburbIndexProcedure is the fully-qualified name of the
	// ShortedStocksService's GetSuburbIndex RPC.
	ShortedStocksServiceGetSuburbIndexProcedure = "/shorts.v1alpha1.ShortedStocksService/GetSuburbIndex"
	// ShortedStocksServiceGetSuburbMetricColumnsProcedure is the fully-qualified name of the
	// ShortedStocksService's GetSuburbMetricColumns RPC.
	ShortedStocksServiceGetSuburbMetricColumnsProcedure = "/shorts.v1alpha1.ShortedStocksService/GetSuburbMetricColumns"
	// ShortedStocksServiceFilterSuburbsProcedure is the fully-qualified name of the
	// ShortedStocksService's FilterSuburbs RPC.
	ShortedStocksServiceFilterSuburbsProcedure = "/shorts.v1alpha1.ShortedStocksService/FilterSuburbs"
...
var (
	...
	shortedStocksServiceGetStockPricesMethodDescriptor                  = shortedStocksServiceServiceDescriptor.Methods().ByName("GetStockPrices")
	shortedStocksServiceGetMarketByDateMethodDescriptor                 = shortedStocksServiceServiceDescriptor.Methods().ByName("GetMarketByDate")
	shortedStocksServiceGetIndexSeriesMethodDescriptor                  = shortedStocksServiceServiceDescriptor.Methods().ByName("GetIndexSeries")
	shortedStocksServiceListIndicesMethodDescriptor                     = shortedStocksServiceServiceDescriptor.Methods().ByName("ListIndices")
	...
	shortedStocksServiceGetSuburbIndexMethodDescriptor                  = shortedStocksServiceServiceDescriptor.Methods().ByName("GetSuburbIndex")
	shortedStocksServiceGetSuburbMetricColumnsMethodDescriptor          = shortedStocksServiceServiceDescriptor.Methods().ByName("GetSuburbMetricColumns")
	shortedStocksServiceFilterSuburbsMethodDescriptor                   = shortedStocksServiceServiceDescriptor.Methods().ByName("FilterSuburbs")
...
func NewShortedStocksServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ShortedStocksServiceClient {
	...
	return &shortedStocksServiceClient{
		...
		getStockPrices: connect.NewClient[v1alpha1.GetStockPricesRequest, v1alpha1.GetStockPricesResponse](
			httpClient,
			baseURL+ShortedStocksServiceGetStockPricesProcedure,
			connect.WithSchema(shortedStocksServiceGetStockPricesMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		...
		getIndexSeries: connect.NewClient[v1alpha1.GetIndexSeriesRequest, v1alpha1.GetIndexSeriesResponse](
			httpClient,
			baseURL+ShortedStocksServiceGetIndexSeriesProcedure,
			connect.WithSchema(shortedStocksServiceGetIndexSeriesMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		listIndices: connect.NewClient[v1alpha1.ListIndicesRequest, v1alpha1.ListIndicesResponse](
			httpClient,
			baseURL+ShortedStocksServiceListIndicesProcedure,
			connect.WithSchema(shortedStocksServiceListIndicesMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		...
		getSuburbIndex: connect.NewClient[v1alpha1.GetSuburbIndexRequest, v1alpha1.GetSuburbIndexResponse](
			httpClient,
			baseURL+ShortedStocksServiceGetSuburbIndexProcedure,
			connect.WithSchema(shortedStocksServiceGetSuburbIndexMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		getSuburbMetricColumns: connect.NewClient[v1alpha1.GetSuburbMetricColumnsRequest, v1alpha1.GetSuburbMetricColumnsResponse](
			httpClient,
			baseURL+ShortedStocksServiceGetSuburbMetricColumnsProcedure,
			connect.WithSchema(shortedStocksServiceGetSuburbMetricColumnsMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		filterSuburbs: connect.NewClient[v1alpha1.FilterSuburbsRequest, v1alpha1.FilterSuburbsResponse](
			httpClient,
			baseURL+ShortedStocksServiceFilterSuburbsProcedure,
			connect.WithSchema(shortedStocksServiceFilterSuburbsMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		...
		getDropIndexSeries: connect.NewClient[v1alpha1.GetDropIndexSeriesRequest, v1alpha1.GetDropIndexSeriesResponse](
			httpClient,
			baseURL+ShortedStocksServiceGetDropIndexSeriesProcedure,
...
// GetStockPrices calls shorts.v1alpha1.ShortedStocksService.GetStockPrices.
func (c *shortedStocksServiceClient) GetStockPrices(ctx context.Context, req *connect.Request[v1alpha1.GetStockPricesRequest]) (*connect.Response[v1alpha1.GetStockPricesResponse], error) {
...
// GetIndexSeries calls shorts.v1alpha1.ShortedStocksService.GetIndexSeries.
func (c *shortedStocksServiceClient) GetIndexSeries(ctx context.Context, req *connect.Request[v1alpha1.GetIndexSeriesRequest]) (*connect.Response[v1alpha1.GetIndexSeriesResponse], error) {
	return c.getIndexSeries.CallUnary(ctx, req)
}

// ListIndices calls shorts.v1alpha1.ShortedStocksService.ListIndices.
func (c *shortedStocksServiceClient) ListIndices(ctx context.Context, req *connect.Request[v1alpha1.ListIndicesRequest]) (*connect.Response[v1alpha1.ListIndicesResponse], error) {
...
// GetSuburbIndex calls shorts.v1alpha1.ShortedStocksService.GetSuburbIndex.
func (c *shortedStocksServiceClient) GetSuburbIndex(ctx context.Context, req *connect.Request[v1alpha1.GetSuburbIndexRequest]) (*connect.Response[v1alpha1.GetSuburbIndexResponse], error) {
	return c.getSuburbIndex.CallUnary(ctx, req)
}

// GetSuburbMetricColumns calls shorts.v1alpha1.ShortedStocksService.GetSuburbMetricColumns.
func (c *shortedStocksServiceClient) GetSuburbMetricColumns(ctx context.Context, req *connect.Request[v1alpha1.GetSuburbMetricColumnsRequest]) (*connect.Response[v1alpha1.GetSuburbMetricColumnsResponse], error) {
	return c.getSuburbMetricColumns.CallUnary(ctx, req)
}

// FilterSuburbs calls shorts.v1alpha1.ShortedStocksService.FilterSuburbs.
func (c *shortedStocksServiceClient) FilterSuburbs(ctx context.Context, req *connect.Request[v1alpha1.FilterSuburbsRequest]) (*connect.Response[v1alpha1.FilterSuburbsResponse], error) {
...
// GetDropIndexSeries calls shorts.v1alpha1.ShortedStocksService.GetDropIndexSeries.
func (c *shortedStocksServiceClient) GetDropIndexSeries(ctx context.Context, req *connect.Request[v1alpha1.GetDropIndexSeriesRequest]) (*connect.Response[v1alpha1.GetDropIndexSeriesResponse], error) {
...
func NewShortedStocksServiceHandler(svc ShortedStocksServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	shortedStocksServiceGetStockPricesHandler := connect.NewUnaryHandler(
		ShortedStocksServiceGetStockPricesProcedure,
		svc.GetStockPrices,
		connect.WithSchema(shortedStocksServiceGetStockPricesMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	...
	shortedStocksServiceGetIndexSeriesHandler := connect.NewUnaryHandler(
		ShortedStocksServiceGetIndexSeriesProcedure,
		svc.GetIndexSeries,
		connect.WithSchema(shortedStocksServiceGetIndexSeriesMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	shortedStocksServiceListIndicesHandler := connect.NewUnaryHandler(
		ShortedStocksServiceListIndicesProcedure,
		svc.ListIndices,
		connect.WithSchema(shortedStocksServiceListIndicesMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	...
	shortedStocksServiceGetSuburbIndexHandler := connect.NewUnaryHandler(
		ShortedStocksServiceGetSuburbIndexProcedure,
		svc.GetSuburbIndex,
		connect.WithSchema(shortedStocksServiceGetSuburbIndexMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	shortedStocksServiceGetSuburbMetricColumnsHandler := connect.NewUnaryHandler(
		ShortedStocksServiceGetSuburbMetricColumnsProcedure,
		svc.GetSuburbMetricColumns,
		connect.WithSchema(shortedStocksServiceGetSuburbMetricColumnsMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	shortedStocksServiceFilterSuburbsHandler := connect.NewUnaryHandler(
		ShortedStocksServiceFilterSuburbsProcedure,
		svc.FilterSuburbs,
		connect.WithSchema(shortedStocksServiceFilterSuburbsMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	...
	shortedStocksServiceGetDropIndexSeriesHandler := connect.NewUnaryHandler(
		ShortedStocksServiceGetDropIndexSeriesProcedure,
	...
	return "/shorts.v1alpha1.ShortedStocksService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case ShortedStocksServiceGetStockPricesProcedure:
			shortedStocksServiceGetStockPricesHandler.ServeHTTP(w, r)
		case ShortedStocksServiceGetMarketByDateProcedure:
			shortedStocksServiceGetMarketByDateHandler.ServeHTTP(w, r)
		case ShortedStocksServiceGetIndexSeriesProcedure:
			shortedStocksServiceGetIndexSeriesHandler.ServeHTTP(w, r)
		case ShortedStocksServiceListIndicesProcedure:
			shortedStocksServiceListIndicesHandler.ServeHTTP(w, r)
		...
		case ShortedStocksServiceGetSuburbIndexProcedure:
			shortedStocksServiceGetSuburbIndexHandler.ServeHTTP(w, r)
		case ShortedStocksServiceGetSuburbMetricColumnsProcedure:
			shortedStocksServiceGetSuburbMetricColumnsHandler.ServeHTTP(w, r)
		case ShortedStocksServiceFilterSuburbsProcedure:
			shortedStocksServiceFilterSuburbsHandler.ServeHTTP(w, r)
...
func (UnimplementedShortedStocksServiceHandler) GetStockPrices(context.Context, *connect.Request[v1alpha1.GetStockPricesRequest]) (*connect.Response[v1alpha1.GetStockPricesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("shorts.v1alpha1.ShortedStocksService.GetStockPrices is not implemented"))
}
...
func (UnimplementedShortedStocksServiceHandler) GetIndexSeries(context.Context, *connect.Request[v1alpha1.GetIndexSeriesRequest]) (*connect.Response[v1alpha1.GetIndexSeriesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("shorts.v1alpha1.ShortedStocksService.GetIndexSeries is not implemented"))
}

func (UnimplementedShortedStocksServiceHandler) ListIndices(context.Context, *connect.Request[v1alpha1.ListIndicesRequest]) (*connect.Response[v1alpha1.ListIndicesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("shorts.v1alpha1.ShortedStocksService.ListIndices is not implemented"))
}
...
func (UnimplementedShortedStocksServiceHandler) GetSuburbIndex(context.Context, *connect.Request[v1alpha1.GetSuburbIndexRequest]) (*connect.Response[v1alpha1.GetSuburbIndexResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("shorts.v1alpha1.ShortedStocksService.GetSuburbIndex is not implemented"))
}

func (UnimplementedShortedStocksServiceHandler) GetSuburbMetricColumns(context.Context, *connect.Request[v1alpha1.GetSuburbMetricColumnsRequest]) (*connect.Response[v1alpha1.GetSuburbMetricColumnsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("shorts.v1alpha1.ShortedStocksService.GetSuburbMetricColumns is not implemented"))
}

func (UnimplementedShortedStocksServiceHandler) FilterSuburbs(context.Context, *connect.Request[v1alpha1.FilterSuburbsRequest]) (*connect.Response[v1alpha1.FilterSuburbsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("shorts.v1alpha1.ShortedStocksService.FilterSuburbs is not implemented"))
}

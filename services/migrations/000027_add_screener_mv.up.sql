-- Materialized view for stock screener: one row per currently-shorted stock
-- Joins shorts, stock_prices, company-metadata, director_trades, news_articles, dividend_history
...
-- Update refresh_all_materialized_views() to include the screener MV

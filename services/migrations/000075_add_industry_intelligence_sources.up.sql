...
VALUES
    ...
    ('abs-international-trade-goods', 'International Trade in Goods', 'trade_exposure', 'Australian Bureau of Statistics', 'https://www.abs.gov.au/statistics/economy/international-trade/international-trade-goods/latest-release', 'CC-BY-4.0', 'Monthly', 'download', TRUE, FALSE, FALSE, 'Industry-level figures only via the reviewed commodity-to-industry crosswalk; no entity-level claims.'),

...
| `/housing/[state]/council` | State council index: every council with a page (kind `council` \| `unincorporated`), ERP population + growth, density, council-wide house median, grant per resident, approvals per 1,000, IRSAD, flood/bushfire shares. ISR 86400 + KV |

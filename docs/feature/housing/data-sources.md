...
| **ABS ERP by LGA** (`ERP_LGA2025`, `ERP_COMP_LGA2025`) | CC-BY-4.0 | `lga.population` (ERP at 30 June), `erp_year`, `pop_growth_pct`; `lga_series` erp + natural increase, net internal / overseas migration |

...
| `abs-retail-trade` | [ABS Retail Trade, Australia](https://www.abs.gov.au/statistics/industry/retail-and-wholesale-trade/retail-trade-australia/latest-release) — **FROZEN: upstream discontinued 2025-06** (superseded by the Monthly Household Spending Indicator; history retained, freshness-exempt) | SDMX `RT` | turnover (seasadj — **keys carry `.seasadj`**), aus + 8 states | M | CC-BY-4.0 |
